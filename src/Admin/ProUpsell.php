...
/**
 * PRO upgrade promotion, shown ONLY on the Returns settings screen: a dismissible
...
final class ProUpsell
{
    ...
    {
        $default = (string) ($this->data()['url'] ?? 'https://plogins.com/plogins-returns-pro/');
        /**
         * Filters the URL the PRO call-to-action buttons point at.
         *
         * @param string $url Default the Returns PRO page.
         */
